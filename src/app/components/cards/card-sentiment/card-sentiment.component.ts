...
@Component({
  ...
  styleUrls: ['./card-sentiment.component.css']
})
...
export class CardSentimentComponent implements OnInit {
  ...
  // from tailwindcss
  @Input()
  get statColor(): string {
    return this._statColor;
  }
  set statColor(statColor: string) {
    this._statColor =
      statColor === undefined ? "bg-red-500" : statColor;
  }
  private _statColor = "bg-red-500";
